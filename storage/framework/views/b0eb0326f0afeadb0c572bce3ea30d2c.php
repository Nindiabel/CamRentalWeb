   ...
   <table class="table">
        ...
        <tbody>
            <tr>
                ...
                <td>1234567890</td>
                <td>
                    <a href="<?php echo e(route('penyewa.edit', 1)); ?>" class="btn btn-primary">Edit</a>
                    <<form action="<?php echo e(route('penyewa.destroy', 1)); ?>" method="POST">
                        <?php echo csrf_field(); ?> <!-- Tambahkan tag <?php echo csrf_field(); ?> di dalam formulir -->
            ...
            <tr>
                ...
                <td>9876543210</td>
                <td>
                    <a href="<?php echo e(route('penyewa.edit', 2)); ?>" class="btn btn-primary">Edit</a>
                    <form action="<?php echo e(route('penyewa.destroy', 1)); ?>" method="POST">
                        <?php echo csrf_field(); ?> <!-- Tambahkan tag <?php echo csrf_field(); ?> di dalam formulir -->
                        <?php echo method_field('DELETE'); ?>
                        <button type="submit" class="btn btn-danger">Delete</button>
    ...
    <a href="<?php echo e(route('penyewa.create')); ?>" class="btn btn-primary btn-tambah">Tambah</a>

    <script src="path_to_your_bootstrap_js/bootstrap.min.js"></script>
</body>

</html>
<?php /**PATH C:\Users\asusb\cam_rental - Copy\cam_rental\resources\views/penyewa/index.blade.php ENDPATH**/ ?>